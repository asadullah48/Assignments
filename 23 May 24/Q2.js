...
var getStrings = scrambledArray.filter(function (string) { return typeof string === 'string'; });
console.log('after removing not-string items\n', getStrings); // boolean and number elements are removed using filter().
var optionalChar = getStrings.join(' ');
...
console.log("\n-=-=-=- Unscrambled Output -=-=--=- \n\n ".concat(Object.values(unscrambledArray).join(' '), "."));
